<?php
    ...
    // On rappelle (je sais pas hein, je tente des trucs)
    ...
    $destinataire = "drzoigeberg@gmail.com";
    $objet        = "[Site cour des Halles] " . $sujet;
    ...
    if ( (empty($nom)) && (empty($sujet)) && (empty($email)) && (!filter_var($email, FILTER_VALIDATE_EMAIL)) && (empty($message)) ) {
        echo 'echec :( <br /><a href="http://arkadia.digital/Halles/?page_id=36">Retour au formulaire</a>';
    } else {
